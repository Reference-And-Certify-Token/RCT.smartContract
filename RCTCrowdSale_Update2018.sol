...
contract RCToken is StandardToken, CarefulOperation {
    ...
    uint256 public constant blocksperDay =  3456; // avg time = 25s/block, 1 day -> 3456 blocks
    uint256 public fundingStartBlock;
    uint256 public fundingEndBlock;
    uint256 public constant rctFund = (0.3 + 0.016) * 420 * (10**6) * 10**decimals  ;
    uint256 public constant icoCap =  (0.4 - 0.016) * 420 * (10**6) * 10**decimals  ;
    ...
    function tokenRate() constant returns(uint) {
        if (block.number>=fundingStartBlock && block.number<fundingStartBlock+(1*blocksperDay)) return 7392; // early bird
